const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CgO32zVY.js","assets/chunks/framework.D6KCzf1D.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CgO32zVY.js"), true ? __vite__mapDeps([0,1]) : void 0));
