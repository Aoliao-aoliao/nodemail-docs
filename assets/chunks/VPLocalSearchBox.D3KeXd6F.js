import { Z as __vitePreload, z as watch, h as computed, al as toArray, am as toValue, an as unrefElement, ao as notNullish, ap as tryOnScopeDispose, E as shallowRef, d as defineComponent, aq as computedAsync, y as ref, ar as useSessionStorage, as as useLocalStorage, x as watchEffect, at as watchDebounced, p as onMounted, U as nextTick, S as onKeyStroke, au as useRouter, av as useEventListener, $ as useScrollLock, B as inBrowser, a3 as onBeforeUnmount, o as openBlock, b as createBlock, j as createBaseVNode, a4 as withModifiers, k as unref, aw as withDirectives, ax as vModelText, ay as isRef, c as createElementBlock, n as normalizeClass, e as createCommentVNode, H as renderList, G as Fragment, a as createTextVNode, t as toDisplayString, az as Teleport, aA as markRaw, aB as createApp, a9 as dataSymbol, ae as pathToFile, aC as escapeRegExp, _ as _export_sfc } from "./framework.D6KCzf1D.js";
import { u as useData } from "./theme.BfW7qvLm.js";
const localSearchIndex = { "root": () => __vitePreload(() => import("./@localSearchIndexroot.Cxkot_t8.js"), true ? [] : void 0) };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function onMouseMove(e) {
      ...
      const el2 = e.target?.closest(".result");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        createBaseVNode("div", {
          ...
          ref: el,
          role: "button",
          "aria-owns": results.value?.length ? "localsearch-list" : void 0,
          "aria-expanded": "true",
          ...
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("form", {
              ...
              createBaseVNode("label", {
                title: unref(translate)("button.buttonText"),
              ...
              withDirectives(createBaseVNode("input", {
                ...
                "aria-controls": results.value?.length ? "localsearch-list" : void 0,
                "aria-labelledby": "localsearch-label",
                autocapitalize: "off",
                autocomplete: "off",
                autocorrect: "off",
                ...
                enterkeyhint: "go",
                maxlength: "64",
                placeholder: unref(translate)("button.buttonText"),
                spellcheck: "false",
                type: "search"
              }, null, 8, _hoisted_6), [
            ...
            createBaseVNode("ul", {
              ref_key: "resultsEl",
              ref: resultsEl,
              id: results.value?.length ? "localsearch-list" : void 0,
              role: results.value?.length ? "listbox" : void 0,
              "aria-labelledby": results.value?.length ? "localsearch-label" : void 0,
              class: "results",
