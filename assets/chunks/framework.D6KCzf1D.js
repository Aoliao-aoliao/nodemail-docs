...
function computedAsync(evaluationCallback, initialState, optionsOrRef) {
  ...
  let options;
  if (/* @__PURE__ */ isRef(optionsOrRef)) options = { evaluating: optionsOrRef };
...
function useNavigatorLanguage(options = {}) {
  ...
  const language = /* @__PURE__ */ shallowRef(navigator2 === null || navigator2 === void 0 ? void 0 : navigator2.language);
